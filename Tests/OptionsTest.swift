...
class OptionsTest: XCTestCase {
    ...
    func testValidVodUrl() throws{
        let option = try Options(mediaUrl: "https://cdn.api.video/vod/vi5oDagRVJBSKHxSiPux5rYD/hls/manifest.m3u8", metadata: [[:]], onSessionIdReceived: nil, onPing: nil)
    ...
    func testValidLiveUrl() throws{
        let option = try Options(mediaUrl: "https://live.api.video/li6Anin2CG1eWirOCBnvYDzI.m3u", metadata: [[:]], onSessionIdReceived: nil, onPing: nil)
    ...
    func testInvalidUrl() throws{
        XCTAssertThrowsError(try Options(mediaUrl: "https://mydomain/video.m3u8", metadata: [[:]], onSessionIdReceived: nil, onPing: nil))
    }
